...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between justify-align-center">
		...
		<div class="my-3">
			<button type="button" class="btn btn-slateblue" data-toggle="modal" data-target="#novacategoria"><i class="fas fa-plus"></i></button> 
    ...
    <div class="card mb-5">
		<div class="card-header">
			...
			Exibindo de {{$categorias->firstItem()}} - {{$categorias->lastItem()}} ({{$categorias->total()}} total)
		</div>
					...
					@if(count($categorias) == 0)
						<tr>
							<td colspan="3" class="text-center">
								<button type="button" class="btn btn-link" data-toggle="modal" data-target="#novacategoria"> Adicione uma categoria</button> 
							</td>
						</tr>
					@endif
					...
					<tr>
						...
						<td>
							<form method="post" action="{{route('categorias.destroy', $cat->id)}}">
								<button type="button" onclick="editar({{$cat->id}}, '{{$cat->nome}}')" class="btn btn-sm"><i class="fas fa-edit fa-lg text-slateblue"></i></button>
								@csrf
								@method('DELETE')
    ...
    <!-- Modal Add Categoria -->
    <div class="modal fade" id="novacategoria" tabindex="-1" role="dialog" aria-labelledby="categoriaModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="editarcategoria" tabindex="-1" role="dialog" aria-labelledby="categoriaModalLabel" aria-hidden="true">
