            ...
            <div class="container">
                ...
                @auth
                    <div class="navbar-brand d-flex justify-align-center">
                        ...
                        <a href="{{route('editarfoto')}}" title="Editar foto de usuário">
                            <img src="{{asset(!empty(Auth::user()->img_perfil)?Auth::user()->img_perfil:'img/profile.png')}}" width="28" height="28" class="mr-2 rounded-circle">
                        </a>
                        {{ Auth::user()->name }}
                    </div>
                @endauth
                ...
                <div class="navbar-collapse collapse" id="menu">
                    ...
                    @guest
                        ...
                        <li class="nav-item">
                            <a href="https://github.com/EdivandroLima" target="_blank" class="nav-link"><i class="fab fa-github fa-sm"></i> Edivandro Lima</a>
                        </li>
                    @endguest
                    </ul>
                </div>
