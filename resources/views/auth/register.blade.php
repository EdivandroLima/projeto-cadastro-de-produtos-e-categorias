                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <label for="email"
                                    class=" col-form-label sr-only text-md-right">{{ __('E-Mail Address') }}</label>
                            ...
                            <div class="form-group">
                                <label for="password"
                                    class=" col-form-label sr-only text-md-right">{{ __('Password') }}</label>
                            ...
                            <div class="form-group">
                                <label for="password-confirm"
                                    class=" col-form-label sr-only text-md-right">{{ __('Confirm Password') }}</label>
